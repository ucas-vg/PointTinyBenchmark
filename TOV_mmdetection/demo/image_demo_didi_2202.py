...
checkpoint_file = '../../coco/epoch_12.pth'  # '../../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_3stage/detection/without_weight/epoch_12.pth'

# test a batch of images, show and save the results
ann_file = '../data/coco/annotations/instances_val2017.json'  # debug: only val set
in_folder = '../../TOV_mmdetection_cache/work_dirs/center_like/COCO/detection/his/0225/'  # debug: only specific images
