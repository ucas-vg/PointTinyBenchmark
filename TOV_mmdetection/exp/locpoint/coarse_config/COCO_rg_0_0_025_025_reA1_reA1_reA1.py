...
net = {
    ...
    'RetinaA1': "configs2/COCO/coarsepoint/retinanetA1_r50_fpn_1x_coco400_coarsept.py",
}
...
exps_config = [
    {"round_dir": "round0", "config_file": net['RetinaA1'],
     "input_ann": Var(lambda cfg: f"{cfg.ann_root}/{cfg.ann_info}/instances_train2017_coarse.json")},
    {"round_dir": "round1_reA1", "config_file": net['RetinaA1']},
    {"round_dir": "round2_reA1-reA1", "config_file": net['RetinaA1']},
