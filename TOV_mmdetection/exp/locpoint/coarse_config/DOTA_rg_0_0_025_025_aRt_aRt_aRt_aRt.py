...
net = {
    'aRetinanet': "configs2/DOTA/coarsepoint/retinanet_moment_r50_fpn_gn-neck+head_1x_DOTA_1024_coarsept.py",
}
...
com_cfg = dict(
    ...
    init_coarse_ann=Var(lambda cfg: f"{cfg.ann_root}/{cfg.ann_info}/DOTA_train_1024_coarse.json"),
...
exps_config = [
    {"round_dir": "round0", "config_file": net['aRetinanet'],
     "input_ann": Var(lambda cfg: f"{cfg.ann_root}/{cfg.ann_info}/DOTA_train_1024_coarse.json")},
    {"round_dir": "round1_aRp", "config_file": net['aRetinanet']},
    {"round_dir": "round2_aRp-aRp", "config_file": net['aRetinanet']},
    {"round_dir": "round3_aRp-aRp-aRp", "config_file": net['aRetinanet']}
]
