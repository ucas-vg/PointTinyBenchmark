...
python tools/train.py configs2/COCO/coarsepointv2/coarse_point_refine_r50_fpn_1x_coco400_dbg.py \
  ...
  --resume-from ../TOV_mmdetection_cache/work_dir/COCO/coarsepointv2/noise_rg-0-0-0.25-0.25_1/coarse_point_refine_r50_fpn_1x_coco400/loss0_r8_8_lr0.01_1x_8b8g/epoch_12.pth \
