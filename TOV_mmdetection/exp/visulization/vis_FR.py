...
# model
config_file = 'configs/COCO/NoiseBox/ENoiseBoxPLUS_r50_fpn_1x_coco.py'
# suff, checkpoint_file = 'our', 'outputs/coco_ssddet_base/ssd-det/epoch_12.pth'  # '../../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_3stage/detection/without_weight/epoch_12.pth'
suff, checkpoint_file = 'base', 'outputs/coco_ssddet_base/base/epoch_12.pth'  # '../../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_3stage/detection/without_weight/epoch_12.pth'
...
out_dir = 'outputs/coco_ssddet_base/vis'

imgs = get_img_list(ann_file, in_folder)
...
for f in imgs:
    ...
    f = f.split('.')[0] + f'_{suff}.' + f.split('.')[1]
    model.show_result(
