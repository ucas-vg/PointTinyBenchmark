...
model = dict(
    ...
    train_cfg=dict(
        ...
        fine_proposal=dict(
            ...
            base_ratios=[1, 1.2, 1.3, 0.8, 0.7],  # [1, 1.25, 1.5, 0.75, 0.5][1, 1.5, 2.0, 0.75, 0.5]
            gen_num_per_box=10,
            iou_thr=0.3,  # 0.1 0.5
            gen_num_neg=500,  # 300 1000
        ),
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'VOC2007/noisy_pkl/voc07_trainval_noise-r0.4.json',
        # 'noisy_pkl/instances_train2017_noise-r0.4.json',
...
# resume_from = '../TOV_mmdetection_cache/work_dirs/coarse_cpr/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape_test/epoch_12_1.pth'
