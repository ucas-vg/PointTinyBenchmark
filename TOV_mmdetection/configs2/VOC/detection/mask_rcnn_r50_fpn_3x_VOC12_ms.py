...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1000, 800)],  # [(1333, 800)],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + "VOC2012/cocostyle_coarse_annotations_new/quasi-center-point-0-0-0.25-0.25-0.25_1_with_truebox/qc_voc12sbd_ins_train_cls.json",
    ...
    val=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + "VOC2012/coco_detection_style/voc12_val.json",
        img_prefix=data_root ,  # 'train2017/',
...
evaluation = dict(interval=1, metric=['bbox','segm'],do_final_eval=True)
