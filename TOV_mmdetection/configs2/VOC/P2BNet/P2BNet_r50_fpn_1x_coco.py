...
evaluation = dict(
    ...
    do_final_eval=True,
    save_result_file='../TOV_mmdetection_cache/work_dirs/TinyCOCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape/latest_result.json',
...
load_from = '../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape/n_epoch_12.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape/'
