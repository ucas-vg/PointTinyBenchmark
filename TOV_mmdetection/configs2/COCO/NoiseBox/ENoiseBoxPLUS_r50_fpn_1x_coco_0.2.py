...
data = dict(
    samples_per_gpu=2,  # 2
    workers_per_gpu=4,  # didi-debug 2
...
# load_from = '../TOV_mmdetection_cache/work_dirs/ENoiseBox/COCO/SS/noise_0.4/noise_0.4_ann_sr0.2_br1_with_pbr_2stage_det4.0_with_reg_mil_cls_sampling_mode4/epoch_10.pth'
# load_from=''
