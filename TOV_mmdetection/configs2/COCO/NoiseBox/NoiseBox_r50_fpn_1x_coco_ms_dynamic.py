...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='Shared2FCInstanceMILHeadNoiseBox',
            num_stages=num_stages,
            stage_modes=stage_modes,
            in_channels=256,
...
# load_from = '../TOV_mmdetection_cache/work_dirs/NoiseBox/COCO/noise_0.4/noise_0.4_ann_sr0.2_with_pbr_2stage/epoch_12.pth'
