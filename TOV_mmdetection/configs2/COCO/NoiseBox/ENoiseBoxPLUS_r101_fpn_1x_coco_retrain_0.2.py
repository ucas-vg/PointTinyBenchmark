...
model = dict(
    ...
    roi_head=dict(
        ...
        top_k=7,
        with_atten=False,
        cluster_mode='non',  ###'cluster','upper'
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1333, 880)],
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'noisy_pkl/instances_train2017_noise-r0.2.json',
    ...
    val=dict(
        ...
        test_mode=False,  # modified  7/21 True for test-5000, False for test-4952
        # min_gt_size=2
    ),
    test=dict(
        type=dataset_type,
...
# load_from = '../TOV_mmdetection_cache/work_dirs/ENoiseBox/COCO/noise_0.4/noise_0.4_ann_sr0.2_br1_with_pbr_2stage_det4.0_with_reg/epoch_12.pth'
