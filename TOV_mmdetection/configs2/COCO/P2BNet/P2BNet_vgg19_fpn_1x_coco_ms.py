...
model = dict(
    type='P2BNet',
    pretrained='torchvision://vgg19_bn',
    backbone=dict(
        type='MyVGG',
        depth=19,
        num_stages=5,
...
# resume_from = '../TOV_mmdetection_cache/work_dirs/coarse_cpr/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape_test/epoch_12.pth'
