...
model = dict(
    ...
    mask_head=dict(
        ...
        sizes_of_interest=[16, 32, 64, 128, 256],
        max_proposals=-1,
        topk_per_img=64,
...
# load_from = 'work_dirs/cas_sharefc_softmax_sigmoidneg_milmil_reshape_128_bboxinst/epoch_1.pth'
work_dir = 'work_dirs/cas_sharefc_softmax_sigmoidneg_milmil_reshape_128_bboxinst/'
