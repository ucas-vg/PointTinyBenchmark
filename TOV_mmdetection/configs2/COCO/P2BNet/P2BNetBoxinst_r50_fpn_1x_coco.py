...
model = dict(
    ...
    mask_head=dict(
        ...
        sizes_of_interest=[32, 64, 128, 256, 512],
        max_proposals=-1,
        topk_per_img=64,
...
resume_from ='../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape_Boxinst/epoch_10.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape_Boxinst/'
