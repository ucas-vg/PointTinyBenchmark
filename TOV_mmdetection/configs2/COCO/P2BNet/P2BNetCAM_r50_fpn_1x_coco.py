...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(667, 200), keep_ratio=True),
...
# resume_from = '../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape_cam/epoch_11.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/COCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape_cam/'
