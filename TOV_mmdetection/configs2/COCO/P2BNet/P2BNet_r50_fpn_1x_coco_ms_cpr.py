...
train_pipeline = [
    ...
    # dict(type='Resize', img_scale=[(2000, 380), ],
...
# load_from = '../TOV_mmdetection_cache/work_dirs/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape/epoch_24.pth'
load_from = '../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape_cpr_test/epoch_12_1.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape_cpr_test/'
