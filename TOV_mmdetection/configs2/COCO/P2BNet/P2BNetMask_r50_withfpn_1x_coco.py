...
model = dict(
    ...
    train_cfg=dict(
        ...
        fine_proposal=dict(
            ...
            base_ratios=[1.0, 0.8, 0.7, 1.2, 1.5],
            gen_num_per_box=10,
            iou_thr=0.3,
            gen_num_neg=500,
        ),
...
evaluation = dict(interval=12, metric='bbox', do_final_eval=True)

# evaluation = dict(interval=1, metric='bbox', do_first_eval=True,do_final_eval=True)
find_unused_parameters = True
# load_from = '../TOV_mmdetection_cache/work_dirs/cas_sharefc_softmax_sigmoidneg_milmil_reshape_128_bboxinst_fpn_mask//n_epoch_12.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/cas_sharefc_softmax_sigmoidneg_milmil_reshape_128_bboxinst_fpn_mask/'
# load_from='../TOV_mmdetection_cache/work_dirs/cas_sharefc_softmax_sigmoidneg_milmil_reshape_128_bboxinst_fpn_mask/epoch_12.pth'
