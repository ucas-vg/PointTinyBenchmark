...
model = dict(
    ...
    train_cfg=dict(
        ...
        fine_proposal=dict(
            ...
            shake_ratio=([0.1],[0.05]),
            base_ratios=([1, 1.2, 1.3, 0.8, 0.7],[1, 1.1, 1.15, 0.9, 0.85]),
            gen_num_per_box=10,
            iou_thr=0.3,
            gen_num_neg=500,
        ),
...
# load_from = '../TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_withoutpseudo/epoch_12_1.pth'
resume_from = '/home/pfchen/disk1/cpf/P2BNet/TOV_mmdetection_cache/work_dirs/center_like/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_3stage/epoch_12.pth'
work_dir = '../TOV_mmdetection_cache/work_dirs/coarse_cpr/COCO/ms_cas_sharefc_softmax_sigmoidneg_milmil_reshape_test/'
