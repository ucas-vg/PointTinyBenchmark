...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file=data_root + 'coarse_annotations/instances_train_val_2017_partial.json',
...
# resume_from = '/home/ubuntu/cpf/P2BNet/TOV_mmdetection_cache/work_dirs/TinyCOCO/cas_sharefc_softmax_sigmoidneg_milmil_reshape/epoch_12.pth'
work_dir = '/home/ubuntu/cpf/P2BNet/TOV_mmdetection_cache/work_dirs/COCO/UFO2_label/cas_sharefc_softmax_sigmoidneg_milmil_reshape/'
