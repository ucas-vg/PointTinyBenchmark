...
pretrained='/home/ubuntu/cpf/P2BNet/swin_tiny_patch4_window7_224_22k.pth'
# pretrained='/home/ubuntu/cpf/P2BNet/swin_tiny_patch4_window7_224_22kto1k_finetune.pth'
load_from='/home/ubuntu/cpf/P2BNet/TOV_mmdetection_cache/work_dirs/center_like/COCO/swin/swin_t_ms_cas_sharefc_softmax_sigmoidneg_milmil_withoutpseudo/epoch_12.pth'
model = dict(
    # type='P2BNet',
    pretrained=None,
    backbone=dict(
    ...
    train_cfg = dict(
        base_proposal=dict(
            ...
            base_ratios=[1 / 3, 1 / 2, 1 / 1.5, 1/1.2,1.0, 1.2,1.5, 2.0, 3.0],
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'mask_head': dict(lr_mult=0.1),
            # 'bbox_head': dict(lr_mult=0.1),
            'mask_branch': dict(lr_mult=0.1),
