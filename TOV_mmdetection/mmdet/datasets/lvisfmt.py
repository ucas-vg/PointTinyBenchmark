...
from .import CocoFmtDataset


@DATASETS.register_module()
class LVISV05FmtDataset(CocoFmtDataset):
...
LVISFmtDataset = LVISV05FmtDataset
DATASETS.register_module(name='LVISFmtDataset', module=LVISFmtDataset)


@DATASETS.register_module()
class LVISV1FmtDataset(LVISFmtDataset):
