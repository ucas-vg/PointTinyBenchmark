...
class EllipsePtFeatGenerator(AnchorPtFeatGenerator):
    def __init__(self, a_c, **kwargs):
        self.a_c = a_c
        super().__init__(**kwargs)
...
class CPRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        self.point_refiner = PointRefiner(**point_refiner, debug=debug, strides=s,
